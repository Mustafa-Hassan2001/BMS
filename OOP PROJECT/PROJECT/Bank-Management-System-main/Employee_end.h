...
void Employee_end::menu(){ //Project Menu
    while (true)
    {
        int choice;
...
void Employee_end::insert() // add data of employe
{
    system("cls");
    fstream file;
    cout << "\n-------------------------------------------------------------------------------------------------------" << endl;
...
void Employee_end::display() // Display data of employe
{
    system("cls");
    int total = 1;
    fstream file;
...
void Employee_end::modify() // Modify data of employe
{
    system("cls");
    char checkId[5];
    int found = 0;
...
void Employee_end::search() // Search data of employe
...
void Employee_end::deleted() // Delete data of employe
{
    system("cls");
    char checkId[5];
    fstream file, file1;
...
void Employee_end::waitForEnter()
{
