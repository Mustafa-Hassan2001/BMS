...
//   }  
   ...
   {  
     ...
     intrest();  
     cout<<"Compund interest will be: Rs"<<CI;  
   }  
   ...
   void virtual intrest()  
   {  
    CI=initial_amt*(pow((1+intr/n),(n*years)));  
   }  
 ...
 {  
   ...
   {  
     ...
     cout<<"BALANCE: "<<"\t"<<bal<<endl;  
     intrest();  
     cout<<"Compund interest will be: Rs"<<SI;  
   }  
   void virtual create_ac()  
   {  
    cout<<"\nNEW Savings Account\n"; 
